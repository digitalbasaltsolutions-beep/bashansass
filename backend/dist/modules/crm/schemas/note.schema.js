...
let Note = class Note extends base_schema_js_1.BaseDocument {
    content;
    linkedEntityType;
    linkedEntityId;
    ownerId;
...
__decorate([
    (0, mongoose_1.Prop)({ type: String, enum: ['Contact', 'Deal'], required: true }),
    __metadata("design:type", String)
], Note.prototype, "linkedEntityType", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.Types.ObjectId, required: true }),
    __metadata("design:type", mongoose_2.Types.ObjectId)
], Note.prototype, "linkedEntityId", void 0);
__decorate([
...
exports.NoteSchema.plugin(tenant_plugin_js_1.TenantPlugin);
exports.NoteSchema.index({ organizationId: 1, linkedEntityId: 1 });
